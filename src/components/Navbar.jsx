        ...
        <div className="flex py-4 items-center justify-between">
          ...
          <div className="hidden md:flex md:items-center md:gap-2">
            <NavLink
              ...
              className={({
                isActive,
              }) => `relative text-[17px] font-medium text-[#0b3d64] transition-all hover:text-[#1a9bb9] px-5
            ...
            <div className="relative group">
              <NavLink
                ...
                className={({
                  isActive,
                }) => `flex items-center gap-1.5 relative text-[17px] font-medium text-[#0b3d64] transition-all hover:text-[#1a9bb9] px-5
                ...
                <div className="py-2">
                  {services.map((s) => (
                    <NavLink
                      ...
                      to={s.path}
                      className={({ isActive }) =>
                        `block px-4 py-2.5 text-sm font-medium transition-colors hover:bg-[#1a9bb9]/10 ${
                          isActive ? "text-[#1a9bb9]" : "text-[#0b3d64]"
                        }`
                      }
                    >
                      {s.name}
        ...
        <div className="md:hidden">
          <div className="border-t border-gray-100 bg-white shadow-xl px-4 pb-4 pt-2">
            <NavLink
              ...
              className={({ isActive }) =>
                `block rounded-md px-4 py-3 text-lg font-semibold transition-colors hover:bg-[#1a9bb9]/10 ${
                  isActive ? "text-[#1a9bb9]" : "text-[#0b3d64]"
                }`
              }
              end
              ...
              <div className="ml-2">
                {services.map((s) => (
                  <NavLink
                    ...
                    onClick={() => setMenuOpen(false)}
                    className={({ isActive }) =>
                      `block rounded-md px-4 py-2 text-base font-medium transition-colors hover:bg-[#1a9bb9]/10 ${
                        isActive ? "text-[#1a9bb9]" : "text-[#0b3d64]"
                      }`
                    }
                  >
