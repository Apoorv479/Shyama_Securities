// src/pages/services/Receptionist.jsx
import React, { useState } from "react";
import { Link } from "react-router-dom";
import { motion } from "framer-motion";
import { Phone, Mail, ArrowLeft, Check, ClipboardList, UserCheck, Building } from "lucide-react"; // Added new icons for workflow
import Footer from "../../components/Footer";

// --- IMAGES ARE NOW IMPORTED LOCALLY ---
// Keeping same hero image as requested
import Hero from "../../assets/Receptionist.png"; 
      ...
      <div className="min-h-screen flex flex-col pt-20">
          ...
          <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 flex flex-col lg:flex-row items-center gap-10">
            ...
            >
              <p className="inline-block py-1 px-3 rounded-full bg-white/10 text-sm font-medium">
                Professional Front Desk Services
              </p>

              <h1 className="mt-6 text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">
                Reception and Administrative Support Solutions
              </h1>

              <p className="mt-4 text-white/90 max-w-xl">
                Courteous, trained, and professional front desk staff to manage your lobby, assist guests, handle inquiries, and represent your brand. Trusted by corporations, residential buildings, and hotels for exceptional service and administrative support.
              </p>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="mailto:info.shyamamanpowersolution1@gmail.com?subject=Receptionist%20Service%20Inquiry"
              ...
              <div className="mt-6 text-sm text-white/80">
                <span className="font-semibold">Available:</span> 24/7 · Full-time or
                Part-time
              </div>
            </motion.div>
            ...
            >
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-white/5">
                <SmartImage
                  sources={heroSources}
                  alt="Professional receptionist at a front desk"
            ...
            >
              <div className="lg:col-span-2">
                <h2 className="text-2xl font-bold text-[#0b3d64]">
                  Receptionist Services — What We Offer
                </h2>
                <p className="mt-4 text-gray-700 max-w-prose">
                  Our professionally trained receptionists ensure a welcoming experience, manage visitor flow, handle communications, and maintain a secure and organized front desk. Each team member is vetted for excellent communication skills, professionalism, and administrative competence.
                </p>

                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Visitor Management</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Greeting guests, managing sign-ins, issuing badges, and ensuring a smooth, secure check-in process.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Guest & Client Assistance</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Providing information, answering inquiries, and offering concierge-level support to visitors and staff.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Communication Handling</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Professionally managing multi-line phone systems, screening calls, and directing inquiries to the correct department.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Administrative Support</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Handling mail, scheduling appointments, managing meeting rooms, and assisting with light clerical tasks.
                    </p>
                  </div>
                </div>
                ...
                {/* Why choose us */}
                <div className="mt-10">
                  <h3 className="text-xl font-bold text-[#0b3d64]">Why choose our front desk staff?</h3>
                  <ul className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      "Vetted for Professionalism & Courtesy",
                      "Trained in Communication & Software",
                      "Background-checked professionals",
                      "Uniformed & Articulate",
                    ].map((t) => (
                ...
                <div className="mt-10">
                  <h3 className="text-xl font-bold text-[#0b3d64]">Our Placement Process</h3>
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">1. Define the Role</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        We consult with you to understand your front desk needs, visitor flow, required skills (e.g., software, languages), and company culture.
                      </p>
                    </div>
                    {/* Step 2 */}
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">2. Select & Train</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        We select background-checked candidates and train them on your specific brand voice, visitor policies, and any required software.
                      </p>
                    </div>
                    {/* Step 3 */}
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">3. On-Site Integration</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        Your new receptionist is deployed, ready to represent your brand. We provide ongoing management and support to ensure a seamless fit.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <aside className="p-6 rounded-2xl border border-[#e6f6fa] shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Need a Receptionist Now?</p>
                ...
                <div className="mt-6 text-xs text-gray-500">
                  We provide temporary, part-time, and full-time staffing — send details for a tailored quote.
                </div>
              </aside>
            </motion.section>
            ...
            <motion.section variants={item} className="mt-12">
              ...
              <div className="mt-4 space-y-4">
                ...
                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">What training do your receptionists receive?</summary>
                  <p className="mt-2 text-gray-700">Our staff are trained in customer service, communication protocols, visitor management software, and basic administrative tasks. We also provide site-specific training.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">Can you provide temporary or permanent staff?</summary>
                  <p className="mt-2 text-gray-700">Yes, we offer flexible solutions including temporary cover for leave, full-time permanent placements, and part-time reception services.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">What kind of administrative tasks can they handle?</summary>
                  <p className="mt-2 text-gray-700">Our staff can manage mail and package distribution, book meeting rooms, handle basic data entry, and assist with scheduling.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">Do your staff wear a uniform?</summary>
                  <p className="mt-2 text-gray-700">We can provide staff in professional business attire or in a standard uniform, depending on your company's preference and brand image.</p>
                </details>
        ...
        <footer className="bg-[#f8feff] border-t border-white/60">
          <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">Ready to elevate your front desk?</div>
              <div className="mt-2 text-lg font-semibold text-[#0b3d64]">Book our professional receptionists today</div>
            </div>
