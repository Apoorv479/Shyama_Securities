// src/pages/services/OfficeSupportStaff.jsx
...
import Hero from "../../assets/peon.png"; 
      ...
      <div className="min-h-screen flex flex-col pt-20">
          ...
          <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 flex flex-col lg:flex-row items-center gap-10">
            ...
            >
              <p className="inline-block py-1 px-3 rounded-full bg-white/10 text-sm font-medium">
                Office boys, supervisors, helpers, etc.
              </p>

              <h1 className="mt-6 text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">
                 Premier Office Support Staff Services
              </h1>

              <p className="mt-4 text-white/90 max-w-xl">
                Reliable, trained, and professional support staff to ensure your workplace runs smoothly. Trusted by businesses for efficient daily operations, administrative support, and internal logistics.
              </p>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="mailto:info.shyamamanpowersolution1@gmail.com?subject=Office%20Support%20Staff%20Inquiry"
            ...
            >
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-white/5">
                <SmartImage
                  sources={heroSources}
                  alt="Office support staff assisting in a corporate environment"
            ...
            >
              <div className="lg:col-span-2">
                <h2 className="text-2xl font-bold text-[#0b3d64]">
                  Office Support Services — What We Offer
                </h2>
                <p className="mt-4 text-gray-700 max-w-prose">
                  Our professionally trained and vetted support staff keep your office operations running seamlessly. We provide reliable office boys, helpers, and supervisors to handle daily tasks, administrative support, and internal logistics.
                </p>
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    ...
                    <p className="mt-2 text-gray-600 text-sm">
                      Handling document filing, photocopying, scanning, and distributing internal mail and memos.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Pantry & Utility Management</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Managing pantry supplies, serving tea/coffee, and ensuring meeting rooms are always prepared and tidy.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Internal Logistics & Errands</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Running office errands, managing couriers, and assisting with the movement of files or light equipment within the office.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Supervisory & Helper Staff</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Providing experienced supervisors to manage support teams or general helpers for various day-to-day tasks.
                    </p>
                  </div>
                </div>
                ...
                {/* Why choose us */}
                <div className="mt-10">
                  <h3 className="text-xl font-bold text-[#0b3d64]">Why choose our office support staff?</h3>
                  <ul className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      "Trained in Office Etiquette & Professionalism",
                      "Vetted for Reliability & Punctuality",
                ...
                <div className="mt-10">
                  <h3 className="text-xl font-bold text-[#0b3d64]">Our Deployment & Management Process</h3>
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">1. Define Your Needs</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        We consult with you to understand your exact requirements—staff roles (office boy, helper), number of staff, shift timings, and specific duties.
                      </p>
                    </div>
                    {/* Step 2 */}
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">2. Staff Vetting & Training</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        We select background-checked individuals from our pool and provide specific training on your company's culture and assigned tasks.
                      </p>
                    </div>
                    {/* Step 3 */}
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      ...
                      <p className="mt-3 text-gray-600 text-sm">
                        Our staff are deployed to your site with clear instructions and professional uniforms. We provide ongoing supervision and management.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <aside className="p-6 rounded-2xl border border-[#e6f6fa] shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Need Office Support Staff?</p>
                ...
                <div className="mt-6 text-xs text-gray-500">
                  We provide temporary, part-time, and full-time staff — send details for a tailored quote.
                </div>
              </aside>
            </motion.section>
            ...
            <motion.section variants={item} className="mt-12">
              ...
              <div className="mt-4 space-y-4">
                ...
                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">What tasks do office support staff handle?</summary>
                  <p className="mt-2 text-gray-700">Our staff typically handle tasks like filing, photocopying, mail distribution, pantry management, meeting room setup, and running office errands.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">Are the staff trained and background-checked?</summary>
                  <p className="mt-2 text-gray-700">Yes. All our staff undergo a thorough background verification process and are trained in basic office etiquette, professionalism, and hygiene.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">Can you provide temporary or part-time staff?</summary>
                  <p className="mt-2 text-gray-700">Absolutely. We offer flexible staffing solutions, including temporary staff for events, part-time support, and full-time permanent placements.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">Do the staff wear a uniform?</summary>
                  <p className="mt-2 text-gray-700">Yes, all our support staff are provided with a clean and professional uniform, ensuring they are easily identifiable and maintain a smart appearance.</p>
                </details>
        ...
        <footer className="bg-[#f8feff] border-t border-white/60">
          <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">Ready to streamline your office?</div>
              <div className="mt-2 text-lg font-semibold text-[#0b3d64]">Book our professional support staff today</div>
            </div>
...
export default OfficeSupportStaff;