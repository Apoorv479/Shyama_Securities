// src/pages/services/SecurityGuard.jsx
import React, { useState } from "react";
import { Link } from "react-router-dom";
import { motion } from "framer-motion";
import { Phone, Mail, ArrowLeft, Check, ClipboardList, UserCheck, ShieldCheck } from "lucide-react"; // Added new icons
import Footer from "../../components/Footer";


import bouncerHero from "../../assets/hero1.jpg"; 
      ...
      <div className="min-h-screen flex flex-col pt-20">
          ...
          <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 flex flex-col lg:flex-row items-center gap-10">
            ...
            >
              ...
              <h1 className="mt-6 text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">
                Expert Security Guard & Staff Services
              </h1>

              <p className="mt-4 text-white/90 max-w-xl">
                Reliable, trained and licensed security staff to manage access control,
                premise safety, guest screening and site security. Trusted by
                corporations, residential complexes, events and private properties for professional conduct
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="mailto:info.shyamamanpowersolution1@gmail.com?subject=Security%20Guard%20Service%20Inquiry"
            ...
            >
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-white/5">
                <SmartImage
                  sources={heroSources}
                  alt="Professional security guards guarding entrance"
            ...
            >
              <div className="lg:col-span-2">
                <h2 className="text-2xl font-bold text-[#0b3d64]">
                  Security Guard Services — What We Offer
                </h2>
                <p className="mt-4 text-gray-700 max-w-prose">
                  Our professionally trained security guards ensure smooth access control,
                  reduce risk, manage site safety, and maintain a secure
                  environment for visitors and staff. Each team member is
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Access Control</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Organizing entry flow, verifying credentials, and handling
                      visitor registration safely and professionally.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Patrol & Monitoring</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Regular patrols, CCTV monitoring, and ensuring only authorized personnel
                      gain access—keeping your premise compliant and secure.
                    </p>
                  </div>
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                  ...
                  <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm">
                    <h3 className="font-semibold text-[#0b3d64]">Safety & Assistance</h3>
                    <p className="mt-2 text-gray-600 text-sm">
                      Trained to protect people and property while maintaining a
                ...
                {/* Why choose us */}
                <div className="mt-10">
                  <h3 className="text-xl font-bold text-[#0b3d64]">Why choose our security guards?</h3>
                  ...
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">1. Risk Assessment</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        We start with a thorough consultation and site visit to understand your property's unique security risks and requirements.
                      </p>
                    </div>
                    {/* Step 2 */}
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">2. Custom Plan</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        We develop a custom security plan, including patrol routes, post orders, and team size, selecting licensed and trained guards for your site.
                      </p>
                    </div>
                    {/* Step 3 */}
                    <div className="p-5 rounded-xl border border-[#e6f6fa] shadow-sm bg-white">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-semibold text-lg text-[#0b3d64]">3. Deployment & Mgmt</h4>
                      </div>
                      <p className="mt-3 text-gray-600 text-sm">
                        Our team is deployed with a supervisor. We ensure seamless integration and provide 24/7 support and detailed incident reporting.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <aside className="p-6 rounded-2xl border border-[#e6f6fa] shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Need Security Guards Now?</p>
            ...
            <motion.section variants={item} className="mt-12">
              ...
              <div className="mt-4 space-y-4">
                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">Are your security guards licensed and insured?</summary>
                  <p className="mt-2 text-gray-700">Yes, all our security personnel are fully licensed, insured, and undergo rigorous background checks as required by law.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">What kind of training do your guards receive?</summary>
                  <p className="mt-2 text-gray-700">Our guards receive comprehensive training in access control, patrol techniques, incident response, conflict de-escalation, and customer service.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">Can you provide guards for 24/7 operations?</summary>
                  <p className="mt-2 text-gray-700">Absolutely. We specialize in providing reliable 24/7 coverage, including night shifts, weekends, and holidays, to ensure your property is always protected.</p>
                </details>

                <details className="p-4 border rounded-lg">
                  <summary className="font-medium text-[#0b3d64] cursor-pointer">How do your guards handle an emergency?</summary>
                  <p className="mt-2 text-gray-700">Our guards are trained to respond calmly and quickly. Their first priority is to ensure safety, followed by contacting emergency services (police, fire, medical) and providing detailed incident reports.</p>
                </details>
              </div>
            </motion.section>
            {/* --------------------------- */}
        ...
        <footer className="bg-[#f8feff] border-t border-white/60">
          <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">Ready to secure your premise?</div>
              <div className="mt-2 text-lg font-semibold text-[#0b3d64]">Book our professional security guards today</div>
            </div>
