        ...
        <div className="flex h-10 md:h-12 items-center justify-between text-xs md:text-sm">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            >
              ...
              <span className="hidden sm:inline break-all">info.shyamamanpowersolution1@gmail.com</span>
              <span className="sm:hidden break-all">info.shyamamanpowersolution1@gmail.com</span>
            </a>
          </div>
